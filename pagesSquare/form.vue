<template>
	<view class="container">
		...
		<u-form labelPosition="left" :model="form" :rules="rules" ref="uForm">
			<u-form-item label="真实姓名" labelWidth="140" prop="name" borderBottom>
				<u--input v-model="form.name" border="none" inputAlign="right" placeholder="请输入真实姓名"></u--input>
			</u-form-item>
			<u-form-item label="身份证号" labelWidth="140" prop="idcard" borderBottom>
				<u--input v-model="form.idcard" border="none" inputAlign="right" placeholder="请输入身份证号"></u--input>
			</u-form-item>
			...
			<u-form-item label="手机号" labelWidth="140" prop="phonenumber" borderBottom>
				<u--input v-model="form.phonenumber" type="number" border="none" inputAlign="right" placeholder="请输入手机号"></u--input>
			</u-form-item>
			<u-form-item label="微信号(互相关注可查看)" labelWidth="340" prop="wechatId" borderBottom>
				<u--input v-model="form.wechatId" border="none" inputAlign="right" placeholder="请输入微信号"></u--input>
			</u-form-item>
		...
		<view style="margin: 30px auto;">
			<u-button type="primary" text="确认信息并实名" color="#211C22" @click="submit()"></u-button>
		</view>
		<u-datetime-picker
			:show="showTime"
			v-model="value1"
...
<script>
	import { uploadImg, infoAdd } from '@/api/square/form.js'
	let that
	export default {
		data(){
			return{
